          ...
          <div class="row">
            ...
            <div class="row justify-content-center mb-5">
              <div class="col-md-7 text-center border-primary">
                <h2 class="font-weight-light text-primary">Website Design And Development</h2>
              </div>
              <div class="col-md-10 text-center">
              <p>Our strategy is always based on client’s requirements which involves understanding the pain points before getting into the coding part. And then using this important piece of information to design a tailor-made website for your business. We implement best practices and programming methodologies that are long-term benefits in terms of functionality and business.</p>
              </div>
            </div>
