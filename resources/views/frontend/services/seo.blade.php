          ...
          <div class="row">
            ...
            <div class="row justify-content-center mb-5">
              <div class="col-md-7 text-center border-primary">
                <h2 class="font-weight-light text-primary">SEO Content Writing Services</h2>
              </div>
              <div class="col-md-10 text-center">
              <p>At your office its only you to communicate with the clients but on your website its actually the content that does the work on your behalf. And its always important to communicate well in order get those projects coming in. Proper content and optimization is important to leave ever-lasting impact on your buyers. That’s actually what we do for you.

                As a Digital Marketing Agency, we understand that being “good” is not enough. Good won’t fetch you eyes from your potential buyers in heavy-market competitions. Engaging content will not only define your brand’s presence online but can also bring fruitful results in the form of Sign-ups, Registrations, Purchases and many word of mouth recommendations.
                
                At Rankfrog we do loads of competition and industry research before laying out a proper content strategy for your business. We publish engaging content keeping in mind best practices and business goals on Website, Blogs, LinkedIn, Facebook, and other platforms.</p>
              </div>
            </div>
          ...
          <div class="container">  
            ...
            <div class="card-body">                 
                  <div class="row">
                      ...
                      <form method="post" action="{{route('website-development')}}" class="p-5 bg-white">
                        {{ csrf_field() }}
