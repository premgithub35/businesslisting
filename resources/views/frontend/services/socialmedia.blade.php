          ...
          <div class="row">
            ...
            <div class="row justify-content-center mb-5">
              <div class="col-md-7 text-center border-primary">
                <h2 class="font-weight-light text-primary">Social Media Marketing</h2>
              </div>
              <div class="col-md-10 text-center">
              <p>Reportedly, nearly 80% of the people spend 2-3 hours of their day on Social Media. Any guesses to where will the the Marketeers go for Selling Products and Brand Visibility?</p>
              </div>
            </div>
          ...
          <div class="container"> 
            ...
            <div class="card-body">                 
                  <div class="row">
                      ...
                      <form method="post" action="{{route('social-media-market')}}" class="p-5 bg-white">
                        {{ csrf_field() }}
