    ...
    <div class="card">
                <div class="card-header">
                  ...
                  <div class="pull-right box-tools">
                    <a href="{{route('add-categories')}}" class="btn btn-success btn-sm btn-flat" > <i class="fa fa-plus"></i> Add New Categories </a>
                  </div>
                </div>
         ...
         <div class="col-md-3">
          ...
          <div class="col-md-3">
            <input type="text" class="form-control " name="name"  placeholder=" Enter name" value="{{app('request')->input('name') }}">
                   ...
                   <a href="{{'categories'}}" class="btn btn-danger btn-md"><span class="fa fa-remove"></span></a>
                    </span>
                 </div>   
...
<hr/>
         ...
         <tbody class="text-capitalize">
          @foreach($categories as $i => $cat)
              <tr>
                  <td style="color:dimgrey"><b>{{ $cat->id }}</b></td>
                  <td><b> {{ $cat->name }}</b></td>
                  {{-- <td>{!! $cat->content !!}</td> --}}
                ...
                @endif
                  ...
                  <td>
                    <a href="{{route('edit-categories',$cat->id)}}" class="btn btn-sm btn-primary"><i class="fa fa-edit"></i></a>
                    <a href="{{route('active-categories',$cat->id)}}" class="btn btn-sm btn-danger"><i class="fa fa-remove"></i></a>
                    <a href="{{route('inactive-categories',$cat->id)}}" class="btn btn-sm btn-success"><i class="fa fa-check-square"></i></a>
                    </td>
                  </tr>
              @endforeach
      </tbody>
