    ...
    <div class="container">
        ...
        <br>
            ...
            <div class="card card-primary">
                    ...
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form role="form" action="{{route('update-user',$user->id)}}" method="post">
                            @csrf 
                      <div class="card-body">
                        ...
                        <input type="number" class="form-control" id="email" value="{{$user->email}}" placeholder="Enter email" name="email">
                        </div>
