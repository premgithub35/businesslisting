    ...
    <div class="card">
                <div class="card-header">
                  ...
                  <div class="pull-right box-tools">
                    <a href="{{route('imenus-add')}}" class="btn btn-success btn-sm btn-flat" > <i class="fa fa-plus"></i> Add New Business </a>
                  </div>
                </div>
...
<hr/>
            ...
            <thead>
                ...
                <th><a href="javascript:void(0)">Images</a></th>
         ...
         <tbody class="text-capitalize">
          @foreach($imenus as $i => $imenu)
              <tr>
                  ...
                  <td><b> {{ $imenu->name }}</b></td>
                  {{-- <td style="color: dimgrey" > <b>{{ $imenu->itemtype }}</b></td> --}}
                  <td>{{$imenu->itemtype}}</td>

                  <td style="color: dimgrey"><b>{{ $imenu->address }}</b></td>
                  <td style="color: dimgrey"><b>{{ $imenu->contact }}</b></td>
                  <td style="color: dimgrey"><b>{{ $imenu->img_url}}</b></td>
